...
**This index introduces the essential concepts for the SIFAP modernization workshop—what you will learn, in what order, how long it takes, and how each concept connects to the individual challenge stages.**
...
| Field | Value |
|---|---|
| **Target audience** | Any participant, including non-developers |
...
- Distinguish a role skill from a stage agent and know how they compose in Copilot Chat
...
- Apply the modernization method to a legacy system that is not a mainframe
...
flowchart TD
    ...
    F["06 — Architecture Decision Records<br/><sub>How to record decisions for future maintainers</sub>"]:::step
...
| 02 | [Agents and Personas](02-agents-and-personas.md) | Role skill that loads itself × stage agent you select | All |
...
| 07 | [The Method Beyond Mainframe](07-method-beyond-mainframe.md) | The same evidence-first method applied to COBOL, Delphi, VB6, PL/SQL, and undocumented monoliths | All |

---

## Connection to the challenge stages
...
| Final judge validation | Copilot's 3 Modes, Glossary (CI green, PR, DoD) |
...
- [ ] What is the difference between a role skill (documented in `05-personas/`, living in `.github/skills/`) and a stage agent (in `06-stage-agents/`)?
...
If you answered four out of five, continue to [`../05-personas/`](../05-personas/) and review the role responsibilities you will cover yourself.
