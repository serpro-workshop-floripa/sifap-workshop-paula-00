...
|---|---|---|---|---|---|---|
| <!-- fill in: reader-assigned SIFAP-M-NN or BONUS --> | <!-- fill in: question, never answer --> | <!-- fill in: path:line --> | <!-- fill in --> | <!-- fill in: unconfirmed --> | <!-- fill in --> | <!-- fill in: open / awaiting human validation / closed after human validation --> |
...
- [ ] The reader supplied the relevant canonical ID; `BONUS` findings do not replace relevant canonical slots.
