...
| **SDLC phase** | Stages 1-3: evidence capture, EARS requirements, and traceability checks |
...
| `.github/skills/persona-requirements-engineer/SKILL.md` | Skill | Requirements analysis |
...
| [EARS validation](../../.github/skills/ears-validate/SKILL.md) | Skill | Requirement notation, source evidence, and acceptance checks |
...
Optional integrations follow the [persona setup guidance](../README.md#how-to-activate-your-persona); verify availability and permissions instead of copying manifests.
