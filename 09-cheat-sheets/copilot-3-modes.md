...
**Monitoring:** Keep execution within the authorized task. Intervene or stop
when actions are unsafe, blocked, or out of scope. Use actual tool/run status
instead of assuming a fixed completion time or repeatedly polling.
